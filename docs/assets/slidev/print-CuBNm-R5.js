import{d as _,aj as u,z as h,o as n,b as l,e as t,x as s,B as c,F as f,ag as g,aa as v,l as x,g as b}from"../modules/vue-Bp0QC5Nk.js";import{a as y,u as N,y as m}from"../index-QnS3AvUP.js";import{_ as k}from"./NoteDisplay.vue_vue_type_style_index_0_lang-CDqAm8hy.js";import"../modules/shiki-xld02UP4.js";const w={id:"page-root"},B={class:"m-4"},L={class:"mb-10"},T={class:"text-4xl font-bold mt-2"},V={class:"opacity-50"},H={class:"text-lg"},S={class:"font-bold flex gap-2"},j={class:"opacity-50"},z={key:0,class:"border-main mb-8"},A=_({__name:"print",setup(C){const{slides:d,total:p}=y();u(`
@page {
  size: A4;
  margin-top: 1.5cm;
  margin-bottom: 1cm;
